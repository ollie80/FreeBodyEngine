...
# class ParticleEmitter(engine.core.entity.Entity):
#     def __init__(
#         self,
#         scene,
#         pos: vector,
...
#         tag="none",
#     ):
#         super().__init__(pos, scene, tag=tag)
#         self.morph = morph
#         self.particles = []
...
#                 self.position,
#                 vector(
#                     random.randrange(round(self.hor_min), round(self.hor_max)),
#                     random.randrange(round(self.vert_min), round(self.vert_max)),
#                 ),
#                 self.morph,
#             )
#         )
