...
def compile(source, generator: type[fbusl.generator.Generator], injector: fbusl.injector.Injector, shader_type: Literal["frag", "vert"], file_path="C:\\Users\\Ollie\\Documents\\GitHub\\FreeBodyDev\\FreeBodyEngine\\engine_assets\\shader\\default_shader.fbvert"):
    inj = injector
    ...
    generator = generator(ast, analyser)
    g = gen.generate()
